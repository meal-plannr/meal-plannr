...
public class ApiGatewayResponse {
    ...
    public static final String ERROR_SERIALISING_OBJECT = "Error serialising object";
        ...
        public ApiGatewayResponse build() {
            ...
            if (rawBody != null) {
                ...
                try {
                    ...
                    LOG.error(ERROR_SERIALISING_OBJECT, e);
                    throw new IllegalArgumentException(ERROR_SERIALISING_OBJECT, e);
                }
